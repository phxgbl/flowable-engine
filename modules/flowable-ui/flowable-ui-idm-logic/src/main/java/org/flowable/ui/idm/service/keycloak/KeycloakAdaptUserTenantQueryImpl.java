 ...
 */
public class KeycloakAdaptUserTenantQueryImpl extends UserQueryImpl {
	...
	protected static final Logger LOGGER = LoggerFactory.getLogger(KeycloakAdaptUserTenantQueryImpl.class);

	protected KeycloakConfiguration keycloakConfiguration;

	public KeycloakAdaptUserTenantQueryImpl(KeycloakConfiguration keycloakConfiguration) {
